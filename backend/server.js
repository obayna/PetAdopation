...
app.post('/login', (req, res) => {
    ...
    db.query(sql, [req.body.email], async (err, data) => {
        ...
        if(data.length > 0) {
            ...
            if(match) return res.json({ message: "Success", user: data[0] });
...
app.post("/add-pet", (req, res) => {
    ...
    const values = [req.body.name, req.body.species, req.body.breed || "Unknown", req.body.age || 0, req.body.description || "No description", req.body.image, req.body.user_id];
...
// --- 5. SERVER START ---
// CHANGED TO 8080 TO MATCH RAILWAY SETTINGS
